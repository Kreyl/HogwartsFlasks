...
//  PrintfC("SD init\r");
    ...
    if (blkGetDriverState(&SDC_DRV) != BLK_READY)
      stat |= STA_NOINIT;
...
)
{
    ...
    case GET_SECTOR_COUNT:
        *((DWORD *)buff) = mmcsdGetCardCapacity(&SDC_DRV);
        return RES_OK;
